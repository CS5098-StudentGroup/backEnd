package uk.ac.standrews.cs.service.GetSpouse;
...
public class GetSpouseQuery {
    ...
    public BirthRecords getBirthRecords(Map<String, String> map) throws Exception {
        ...
        query.append("MATCH (b:Birth) ");
        query.append(getIdAttribute(spouse));
        query.append(" RETURN ");
    ...
    public List<MarriageRecords> getMarriageRecords(Map<String, String> map) throws Exception {
        ...
        query.append(getIdAttribute(spouse));
        query.append(" RETURN ");
        query.append(getMarriageReturn(spouse));
    ...
    public static String getIdAttribute(Map<String, String> attribute) {
        ...
        attribute.forEach((key, value) -> {
            switch (key) {
                ...
                case "Spouse_Marriage_id" : query.append(" b.STANDARDISED_ID=").append('"').append(value.toUpperCase()).append('"').append(" AND");break;
            }
        });
    ...
    static String getMarriageReturn(Map<String, String> map) {
        ...
        if(map.get("gender").equals("F")) {r.append(", m.BRIDE_ADDRESS AS SPOUSE_ADDRESS, m.BRIDE_SURNAME AS SPOUSE_SURNAME, m.BRIDE_FORENAME AS SPOUSE_FORENAME, m.BRIDE_IDENTITY AS SPOUSE_IDENTITY," +
        ...
        if(map.get("gender").equals("M")) {r.append(", m.GROOM_ADDRESS AS SPOUSE_ADDRESS, m.GROOM_SURNAME AS SPOUSE_SURNAME, m.GROOM_FORENAME AS SPOUSE_FORENAME, m.GROOM_IDENTITY AS SPOUSE_IDENTITY," +
